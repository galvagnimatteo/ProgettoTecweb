...
$keywords = '';
$breadcrumb ='<a href="home.php">Home</a> / <a href="admin.php"> Amministrazione </a> / Inserimento film';
//GeneratePage($page,$content,$breadcrumbs,$title,$description,$keywords,$jshead,$jsbody);
echo GeneratePage("inserimento film",$content,$breadcrumb,$title,"pagina di inserimento film",$keywords,"","");
